...
def dashboard_view(request) :
    ...
    context = {"user_profile" : user_profile, "total_users" : total_users, "total_quizzes" : total_quizzes, "total_quiz_submit" : total_quiz_submit, "total_questions" : total_questions, "today_users" : today_users, "today_quizzes" : today_quizzes, "today_quiz_submit" : today_quiz_submit, "today_questions" : today_questions, "gain_users" : gain_users, "gain_quizzes" : gain_quizzes , "gain_quiz_submit" : gain_quiz_submit, "gain_questions" : gain_questions, "messages" : messages}
...
def contact_view(request) :
    ...
    if request.method == "POST" :
        ...
        if  subject is not None and message is not None :
            ...
            form.save()
            messages.success(request, "We have recieved Your Message, We will work upon it")
            return redirect('profile', request.user.username)
        else :
            return redirect('contact')
            # message(request,"Enter Your Details")
